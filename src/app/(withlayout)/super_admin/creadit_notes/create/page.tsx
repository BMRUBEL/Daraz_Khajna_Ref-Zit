...
import TableCreditNoteChild from "@/app/(withlayout)/super_admin/creadit_notes/components/Table";
...
const CreateAdminPage = () => {
  ...
  return (
    ...
    >
      <UMBreadCrumb pageName="Credit Note" lastName="Create" />
      <div
        style={{
          padding: "20px 0px",
          marginTop: "0px",
              ...
              <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
                ...
                >
                  <DRZSelectField
                    ...
                    placeholder="--SELECT credit note for--"
                    required
                    onSearch={onSearch}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <DarazCommonButton background="#EEF5FF" color="black">
                    Reset
                  </DarazCommonButton>
                  <DarazCommonButton background="#EEF296" color="black">
                    Draft
                  </DarazCommonButton>
