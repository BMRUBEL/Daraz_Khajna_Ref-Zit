...
} from "@/redux/api/reportApi/mushakSixFiveApi";
...
const MushakSixFive = () => {
  ...
  // drop down data
  const { data: compdata } = useSixFiveCompDropdownQuery({ ...{}, });
  const { data: branchdata } = useSixFiveBranchDropdownQuery({ ...{}, });
  const { data: storedata } = useSixFiveStoreDropdownQuery({  ...{}, });
  const { data: vatdata } = useSixFiveVatDropdownQuery({  ...{}, });
  const { data: transdata } = useSixFiveTransDropdownQuery({  ...{}, });
  ...
  //get grid view data
  const { data: reportData, refetch } = useMushakSixFiveQuery({
                ...
                <td colSpan={12}>
                  <div className="grid grid-cols-12 grid-flow-col gap-0  border p-3 mb-5">
                    ...
                    <div className="col-start-4 col-end-10 text-center">
                      <div className="grid grid-cols-5 grid-flow-col gap-0">
                        ...
                        <div className="col-start-2 col-end-6 text-center">
                          ...
                          <div>
                            <strong> কেন্দ্রীয় নিবন্ধিত প্রতিষ্ঠানের পণ্য স্থানান্তর চালানপত্র</strong>
                          </div>
                          <div>
                            <strong>
                              [বিধি ৪০ এর উপ-বিধি(১) এর দফা (ঙ) দ্রষ্টব্য]
                            </strong>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="col-start-11 col-end-13 text-center">
                      <p className="font-bold">মূসক-৬.৫</p>
                    </div>
                  </div>
                  <div className="grid grid-cols-5 grid-flow-col gap-0 border p-2">
                    <div className="col-start-1 col-end-3 flex">
                      <div className="flex flex-col">
                        ...
                        <div>
                          <strong>প্রেরণকারী ইউনিট/শাখা/পণ্যাগারের নাম ও ঠিকানা: </strong>
                          {leftThree}
                        </div>
                        <div>
                          <strong>গ্রহীতা ইউনিট/শাখা/পণ্যাগারের নাম ও ঠিকানা: </strong>
                          {leftFour}
                        </div>
                      </div>
                    </div>
                    <div className="col-start-4 col-end-6 flex justify-end">
                      <div className="text-right flex flex-col">
                        <div className="overflow-hidden">
                          <strong>চালান নম্বর:</strong> {rightOne}
                        </div>
                        <div className="overflow-hidden">
