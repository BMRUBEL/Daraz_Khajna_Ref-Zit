...
} from "@/redux/api/reportApi/mushakFourFourApi";
...
const MushakFourFive = () => {
 ...
 const query: Record<string, any> = {};
  // drop down data
  const { data: compdata } = useCompanyFourFourDropdownQuery({ ...{}, });
  const { data: branchdata } = useBranchFourFourDropdownQuery({ ...{}, });
  const { data: storedata } = useStoreFourFourDropdownQuery({  ...{}, });
  const { data: vatdata } = useVatMonthFourFourDropdownQuery({  ...{}, });
  ...
  //get grid view data
  const { data: reportData, refetch } = useMushakFourFourQuery({
        ...
        >
          ...
          <tbody>
              ...
              <td colSpan={12}>
                <div className="grid grid-cols-12 grid-flow-col gap-0  border p-3 mb-5">
                  ...
                  <div className="col-start-4 col-end-10 text-center">
                    <div className="grid grid-cols-5 grid-flow-col gap-0">
                      ...
                      <div className="col-start-2 col-end-5 text-center">
                        ...
                        <div>
                          <strong>
                           অব্যবহৃত বা ব্যবহার অনুপযোগী উপকরণ নিস্পত্তির আবেদনপত্র 
                          </strong>
                        </div>
                        <div>
                          <strong>
                           [বিধি ২৪ এর উপ-বিধি(১) দ্রষ্টব্য]
                          </strong>
                        </div>
                  ...
                  <div className="col-start-11 col-end-13 text-center">
                    <p className="font-bold">মূসক-৪.৪</p>
                  </div>
                </div>
            ...
            >
              ...
              >
                ক্রয় চালানপত্রের ক্রমিক সংখ্যা
              </th>
              <th
                style={{
                  border: "1px solid #ccc",
              ...
              >
                অব্যবহৃত বা ব্যবহার অনুপযোগী উপকরণের পরিমাণ
              </th>
              <th
                style={{
                  border: "1px solid #ccc",
