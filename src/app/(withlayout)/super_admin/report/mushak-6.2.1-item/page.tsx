  ...
  const fetchPdfData = async (selectedCompany:any, selectedBranch:any, selectedStoreId:any, selectedVatMonthId:any,) => {
    ...
    try {
      const response = await fetch(
        `http://192.168.10.10:8181/report/api/v1/mushak-six-two-one/gen-pdf-item?companyId=${selectedCompany}&branchId=${selectedBranch}&storeId=${selectedStoreId}&vatMonthId=${selectedVatMonthId}`,
        {
          headers: {
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <h2>Mushak Report 6.2.1 (Item)</h2>
          </div>
          {showReport ? (
            <div>
              <button
...
export default MushakSixTwoOneItem;
