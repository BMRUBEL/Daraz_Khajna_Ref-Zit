...
} from "@/redux/api/reportApi/mushakChak-KhaApi";
...
const MushakSixEight = () => {
  ...
  // drop down data
  const { data: compdata } = useChakKhaCompDropdownQuery({ ...{}, });
  const { data: branchdata } = useChakKhaBranchDropdownQuery({ ...{}, });
  const { data: storedata } = useChakKhaStoreDropdownQuery({  ...{}, });
  const { data: vatdata } = useChakKhaVatDropdownQuery({  ...{}, });
  ...
  //get grid view data
  const { data: reportData, refetch } = useMushakChakKhaQuery({
                    ...
                    <div className="col-start-4 col-end-10 text-center">
                      <div className="grid grid-cols-5 grid-flow-col gap-0">
                        ...
                        <div className="col-start-1 col-end-6 text-center">
                          ...
                          <div>
                            <strong>যে ইউনিটের কেন্দ্রীয় নিবন্ধন গ্রহণ করা হইয়াছে সে ইউনিট বা বিক্রয় ইউনিট  হইতে পণ্য/সেবা সরবরাহ ও রাজস্ব বিবরণী</strong>
                          </div>
                          <div>
                            <strong>
                              [ বিধি ৭ দ্রষ্টব্য ]
