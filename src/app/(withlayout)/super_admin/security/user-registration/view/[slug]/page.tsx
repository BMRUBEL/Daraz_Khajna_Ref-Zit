...
const ViewUserRegistrationPage = ({ params }: any) => {
  // state
  ...
  return (
    ...
    >
      <UMBreadCrumb pageName="User Registration" lastName="View" link={"/super_admin/security/user-registration"} />
      <div
        style={{
          padding: "20px",
          marginTop: "11px",
            ...
            <Link href={`/super_admin/security/user-registration`}>
              ...
              >
                <DarazCommonRedirectButton
                  to={`/super_admin/security/user-registration/edit/${id}`}
                >
                  Go to edit
                </DarazCommonRedirectButton>
...
export default ViewUserRegistrationPage;
