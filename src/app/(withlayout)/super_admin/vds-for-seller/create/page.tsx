...
import DRZoaTableInForm from "@/components/ui/DRZothersadjustmenttable";
import DRZvdsForSellerTableInForm from "@/components/ui/DRZvdsForSellerTableInForm";
...
const CreateVdsForSeller = () => {
  ...
  return (
    <div style={{ padding: "10px" }}>
      <UMBreadCrumb pageName="VDS For Seller" lastName="Insert" />
      <div
        style={{
          padding: "20px",
          marginTop: "11px",
          ...
          <div
            ...
            >
              ...
              >
                ...
                >
                  <Link href={`/super_admin/vds-for-seller`}>
                    {" "}
                    <DarazCommonCloseButton>Close</DarazCommonCloseButton>
                  </Link>
                  <DarazCommonRedirectButton to="/super_admin/vds-for-seller/create">Reset</DarazCommonRedirectButton>
