...
import TransferInChildTable from "@/components/ChildTable/TransferInChildTable";
...
const TransferOutCreatePage = () => {
  ...
  return (
    ...
    >
      <UMBreadCrumb lastName="create" pageName="Transfer In" />
      <div
        style={{
          padding: "20px 0px",
          marginTop: "0px",
            ...
            >
              ...
              <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
                ...
                <Col
                  ...
                  aria-required
                >
                  <label htmlFor="">Pic Transaction <span className="text-red">*</span></label>
                  <Search className="mt-2" placeholder="Pick Transaction"
                    onSearch={onSearch} style={{ width: 250, height: 70, padding: "2px" }} />
                  {/* <FormInput
                    type="text"
                  ...
                  <>
                    ...
                    >
                      <FormInput
                        ...
                        name="admin.name.firstName"
                        size="large"
                        label="Total Issue Ammount in current currency"
                        required
                        disable
                      />
                    </Col>
