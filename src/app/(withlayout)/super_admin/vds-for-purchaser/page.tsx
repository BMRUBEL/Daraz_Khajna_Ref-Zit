...
const VdsForPurchaser = () => {

  const dummyData = [
    { 
      id: 1, 
      spplierName: "Rahim Verities Store", 
      treasuryChallanNo: "TCM-23-00001", 
      certificateNo: "00001", 
    ...
    <>
      ...
      >
        ...
        <div style={{ 
          ...
          <ActionBar>
            <Link href="/super_admin/vds-for-purchaser/create">
...
export default VdsForPurchaser;
