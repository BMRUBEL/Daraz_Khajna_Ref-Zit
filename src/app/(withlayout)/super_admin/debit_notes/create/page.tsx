...
import TableCreditNoteChild from "@/app/(withlayout)/super_admin/debit_notes/components/ChildrenTable";
...
const CreateAdminPage = () => {
  ...
  return (
    ...
    >
      <UMBreadCrumb pageName="Debit Note" lastName="Create" />
      <div
        style={{
          padding: "20px 0px",
          marginTop: "0px",
