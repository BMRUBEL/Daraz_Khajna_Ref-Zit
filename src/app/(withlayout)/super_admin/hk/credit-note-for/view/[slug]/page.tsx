...
const ViewCreditNotePage = ({ params }: any) => {
  // state
  ...
  return (
    ...
    >
      ...
      <UMBreadCrumb pageName="Credit Note For" lastName="View" link="/super_admin/hk/credit-note-for" />
            ...
            <Link href={`/super_admin/hk/credit-note-for`}>
              ...
              >
                <DarazCommonRedirectButton
                  to={`/super_admin/hk/credit-note-for/edit/${id}`}
                >
                  Go to edit
                </DarazCommonRedirectButton>
