...
const CreatePoliceStationPage = () => {
  ...
  const [addPoliceStation, { data: createData }] = useAddPoliceStationMutation();
  ...
  const onSubmit = async (values: any) => {
    try {
      ...
      setLoading(true);
      const res = await addPoliceStation(values);
      ...
      if (res) {
        if(res?.data?.code===400){
          ...
          message.success("Police Station created successfully!");
          router.push(
            `/super_admin/hk/police-station/view/${res?.data?.result?.id}`
          );
          setLoading(false);
        }else{
  ...
  return (
    ...
    >
        ...
        <UMBreadCrumb pageName="Police Station" lastName="Create" link="/super_admin/hk/police-station" />
      ...
      >
        <Form submitHandler={onSubmit} resolver={yupResolver(policeStationSchema)}>
          <div
            style={{
              padding: "0px",
              marginTop: "12px",
            ...
            >
              ...
              >
                <FormInput
                  ...
                  placeholder="Police Station Name BN..."
                  required
                />
              </Col>
              <Col
