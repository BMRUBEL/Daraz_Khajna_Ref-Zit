...
const ViewPoliceStationPage = ({ params }: any) => {
  // state
  ...
  return (
    ...
    >
        ...
        <UMBreadCrumb pageName="Police Station" lastName="View" link="/super_admin/hk/police-station" />
            ...
            <Link href={`/super_admin/hk/police-station`}>
              ...
              >
                <DarazCommonRedirectButton
                  to={`/super_admin/hk/police-station/edit/${id}`}
                >
                  Go to edit
                </DarazCommonRedirectButton>
...
export default ViewPoliceStationPage;
