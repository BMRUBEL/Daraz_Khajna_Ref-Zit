...
const CreateBusinessInformationPage = () => {
  const [loading, setLoading] = useState(false);
  const { data, isLoading } = useDepartmentsQuery({ limit: 100, page: 1 });

  const [addTransaction, { data: createData }] = useAddBusinessInfoMutation();
  console.log(createData, "createBusinessInformation");
    ...
    try {
      ...
      if (res) {
        if(res?.data?.code===400){
          ...
          message.success("Business Information created successfully!");
          router.push(
            `/super_admin/hk/business-information/view/${res?.data?.result?.id}`
          );
          setLoading(false);
        }else{
  ...
  return (
    ...
    >
        ...
        <UMBreadCrumb pageName="Business Information" lastName="Create" link="/super_admin/hk/business-information" />
      ...
      >
        <Form submitHandler={onSubmit} resolver={yupResolver(businessInformationSchema)}>
          <div
            style={{
              padding: "0px",
              marginTop: "12px",
            ...
            >
              ...
              >
                <FormInput
                  ...
                  placeholder="Business Information Name..."
                  required
                />
              </Col>
              ...
              >
                <FormInput
                  ...
                  placeholder="Business Information Name BN..."
                  required
                />
              </Col>
              <Col
...
export default CreateBusinessInformationPage;
