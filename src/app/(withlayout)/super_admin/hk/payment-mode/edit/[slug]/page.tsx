...
} from "@/redux/api/housekeepingApi/paymodeApi";
...
const EditPaymentMode = ({ params }: any) => {
  // state
  ...
  console.log(id, "id");
  const { data = [], isLoading } = useGetSinglePaymodeQuery(id, {});
  // const sourceId: any = data[0]?.tran_source_type_id;
  // console.log(sourceId);

  // console.log(sourceId);
  const [updatePaymode] = useUpdatePaymodeMutation();
    ...
    try {
      ...
      if (res) {
        if(res?.code===400){
          ...
          message.success("Payment Mode Updated successfully!");
          router.push(`/super_admin/hk/payment-mode/view/${id}`);
        }
  ...
  return (
    ...
    >
        ...
        <UMBreadCrumb pageName="Paymode Type" lastName="Update" link="/super_admin/hk/payment-mode" />
      ...
      >
        ...
        resolver={yupResolver(paymodeSchema)}
