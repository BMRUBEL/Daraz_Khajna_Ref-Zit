...
const ViewAreaofEconomicPage = ({ params }: any) => {
  // state
  ...
  return (
    ...
    >
        ...
        <UMBreadCrumb pageName="Area Of Economic Activity" lastName="View" link="/super_admin/hk/area-of-economic-activity" />
            ...
            <Link href={`/super_admin/hk/area-of-economic-activity`}>
              ...
              >
                <DarazCommonRedirectButton
                  to={`/super_admin/hk/area-of-economic-activity/edit/${id}`}
                >
                  Go to edit
                </DarazCommonRedirectButton>
...
export default ViewAreaofEconomicPage;
