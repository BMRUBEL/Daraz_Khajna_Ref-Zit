...
const EditProductType = ({ params }: any) => {
  // state
    ...
    try {
      ...
      if (res) {
        if(res?.code===400){
          ...
          router.push(`/super_admin/hk/product-type/view/${id}`);
        }
  ...
  return (
    ...
    >
      ...
      <UMBreadCrumb pageName="Product Type" lastName="Update" link="/super_admin/hk/product-type" />
