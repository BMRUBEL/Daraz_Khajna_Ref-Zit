...
const EditCountry = ({ params }: any) => {
  ...
  const { data = [], isLoading } = useGetSingleCountryQuery(id, {});
    ...
    try {
      ...
      if (res) {
        if(res?.code===400){
          ...
          router.push(`/super_admin/hk/country/view/${id}`);
        }
  ...
  return (
    ...
    >
      ...
      <UMBreadCrumb pageName="Country" lastName="Update" link={`/super_admin/hk/country`} />
