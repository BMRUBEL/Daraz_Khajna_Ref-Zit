...
} from "@/redux/api/housekeepingApi/countryApi";
...
const CreateCountryPage = () => {
  ...
  const [addCountry, { data: createData }] = useAddCountryMutation();
  ...
  const onSubmit = async (values: any) => {
    try {
      ...
      if (res) {
        ...
        router.push(
          `/super_admin/hk/country/view/${res.data.result.id}`
        );
        setLoading(false);
        }else{
  ...
  return (
    ...
    >
      ...
      <UMBreadCrumb pageName="Country" lastName="Create" link={`/super_admin/hk/country`} />
      ...
      >
        <Form submitHandler={onSubmit} resolver={yupResolver(countrySchema)}>
          <div
            style={{
              padding: "0px",
              marginTop: "12px",
            ...
            >
              ...
              >
                <FormInput
                  ...
                  type="text"
                  name="codeBn"
                  label="Country Code BN: "
                  placeholder="Country Code BN"
                  required
                />
              </Col>
              <Col
    ...
              </Col>
          ...
          >
            ...
            >
              <Link href={`/super_admin/hk/country`}>
                {" "}
