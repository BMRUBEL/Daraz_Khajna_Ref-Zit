...
} from "@/redux/api/housekeepingApi/debitNoteforApi";
import { debitNoteforSchema } from "@/schemas/debitNoteforSchema";
...
const EditDebitNoteFor = ({ params }: any) => {
  // state
    ...
    try {
      ...
      if (res) {
        if(res?.code===400){
          ...
          router.push(`/super_admin/hk/debit-note-for/view/${id}`);
        }
  ...
  return (
    ...
    >
      ...
      <UMBreadCrumb pageName="Debit Note For" lastName="Update" link="/super_admin/hk/debit-note-for" />
      ...
      >
        <Form submitHandler={onSubmit} 
         resolver={yupResolver(debitNoteforSchema)}
...
export default EditDebitNoteFor;
