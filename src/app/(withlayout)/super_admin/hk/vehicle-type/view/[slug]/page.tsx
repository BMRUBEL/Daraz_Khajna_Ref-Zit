...
import { useGetSingleVehicleTypeQuery } from "@/redux/api/housekeepingApi/vehicleTypeApi";
import { Col, Row } from "antd";
import Link from "next/link";
import { useEffect, useState } from "react";

const ViewVehicleTypePage = ({ params }: any) => {
  // state
  ...
  return (
    ...
    >
        ...
        <UMBreadCrumb pageName="Vehicle Type" lastName="View" link={`/super_admin/hk/vehicle-type`} />
            ...
            <Link href={`/super_admin/hk/vehicle-type`}>
              ...
              >
                <DarazCommonRedirectButton
                  to={`/super_admin/hk/vehicle-type/edit/${id}`}
                >
                  Go to edit
                </DarazCommonRedirectButton>
...
export default ViewVehicleTypePage;
