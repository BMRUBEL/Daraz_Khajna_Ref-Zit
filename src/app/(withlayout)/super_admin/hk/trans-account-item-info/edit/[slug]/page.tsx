...
} from "@/redux/api/housekeepingApi/transaccountitemInfoApi";
...
const EditAccountItem = ({ params }: any) => {
  // state
  ...
  const [updateAccountitem] = useUpdateAccountItemMutation();
    ...
    try {
      ...
      if (res) {
        if(res?.code===400){
          ...
          message.success("Trans Account Item Info updated successfully!");
          router.push(`/super_admin/hk/trans-account-item-info/view/${id}`);
        }
  ...
  return (
    ...
    >
        ...
        <UMBreadCrumb pageName="Trans Account Item Info" lastName="Update" link="/super_admin/hk/trans-account-item-info" />
