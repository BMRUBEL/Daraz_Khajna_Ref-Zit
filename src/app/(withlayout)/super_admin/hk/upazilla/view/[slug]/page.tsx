...
import { useGetSingleupazillaQuery } from "@/redux/api/housekeepingApi/upazillaApi";

import { Col, Row } from "antd";
import Link from "next/link";
import { useEffect, useState } from "react";

const ViewUpazillaPage = ({ params }: any) => {
  // state
  ...
  useEffect(() => {
    setDefaultValue({
      ...
      districtNameBn: data.result?.districtNameBn,
  ...
  return (
    ...
    >
       ...
       <UMBreadCrumb pageName="Upazilla" lastName="View" link={`/super_admin/hk/upazilla`} />
            ...
            <Link href={`/super_admin/hk/upazilla`}>
              ...
              >
                <DarazCommonRedirectButton
                  to={`/super_admin/hk/upazilla/edit/${id}`}
                >
                  Go to edit
                </DarazCommonRedirectButton>
...
export default ViewUpazillaPage;
