...
import {  useVatRateRefQuery } from "@/redux/api/housekeepingApi/vatRateRefApi";
...
const ManageAdmin = () => {
  ...
  // get department data
  const { data: transactionData, isLoading } = useVatRateRefQuery({
    ...query,
    page: page,
    size: size,
    sortField: sortBy,
  ...
  const columns = [
    {
      title: "Vat Rate Reference Name",
      dataIndex: "vatRateRefName",
      sorter: true,
      width: 300,
      align: "center",
    },
    {
      title: "Vat Rate Reference Name BN",
      dataIndex: "vatRateRefNameBn",
      width: 300,
      align: "center",
    },
    {
    ...
    },
    {
      ...
      render: (record: any) => (
        ...
        >
          <Link href={`/super_admin/hk/vat-rate-ref/view/${record}`}>
            <Button
              style={{
                fontSize: "13px",
          ...
          <Link href={`/super_admin/hk/vat-rate-ref/edit/${record}`}>
            <Button
              className="bg-[#FF5100]"
              style={{
                fontSize: "13px",
  ...
  return (
    <>
      ...
      >
        <UMBreadCrumb pageName="Vat Rate Reference" />

        <div>
          <ActionBar>
          <DarazCommonAddButton
              to={`/super_admin/hk/vat-rate-ref/create`}
            >
              + Add New
            </DarazCommonAddButton>
            <div>
