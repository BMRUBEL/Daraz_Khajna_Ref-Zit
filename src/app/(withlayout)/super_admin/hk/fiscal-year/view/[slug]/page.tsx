...
const ViewFiscalYearPage = ({ params }: any) => {
  // state
  ...
  return (
    ...
    >
        ...
        <UMBreadCrumb pageName="Fiscal Year Info" lastName="View" link={`/super_admin/hk/fiscal-year`} />
            ...
            <Link href={`/super_admin/hk/fiscal-year`}>
              ...
              >
                <DarazCommonRedirectButton
                  to={`/super_admin/hk/fiscal-year/edit/${id}`}
                >
                  Go to edit
                </DarazCommonRedirectButton>
...
export default ViewFiscalYearPage;
