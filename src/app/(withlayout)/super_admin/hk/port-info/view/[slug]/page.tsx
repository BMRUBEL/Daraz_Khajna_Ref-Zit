...
import { useGetSinglePortInfoQuery } from "@/redux/api/housekeepingApi/portInfoApi";
import { Col, Row } from "antd";
import Link from "next/link";
import { useEffect, useState } from "react";

const ViewPortInfoPage = ({ params }: any) => {
  // state
  ...
  return (
    ...
    >
        ...
        <UMBreadCrumb pageName="Port Info" lastName="View" link={`/super_admin/hk/port-info`} />
            ...
            <Link href={`/super_admin/hk/port-info`}>
              ...
              >
                <DarazCommonRedirectButton
                  to={`/super_admin/hk/port-info/edit/${id}`}
                >
                  Go to edit
                </DarazCommonRedirectButton>
...
export default ViewPortInfoPage;
