...
const ViewBankAccountTypePage = ({ params }: any) => {
  // state
  ...
  return (
    ...
    >
        ...
        <UMBreadCrumb pageName="Bank Account Type" lastName="View" link={`/super_admin/hk/bank-account-type`} />
            ...
            <Link href={`/super_admin/hk/bank-account-type`}>
              ...
              >
                <DarazCommonRedirectButton
                  to={`/super_admin/hk/bank-account-type/edit/${id}`}
                >
                  Go to edit
                </DarazCommonRedirectButton>
...
export default ViewBankAccountTypePage;
