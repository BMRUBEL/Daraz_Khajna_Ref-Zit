...
const ViewAreaPage = ({ params }: any) => {
  // state
  const [defaultValue, setDefaultValue] = useState({});

  const id = params.slug as string;

  const { data = [], isLoading } = useGetSingleAreaQuery(id, {});
  ...
  useEffect(() => {
    setDefaultValue({
      ...
      cityNameBn: data.result?.cityNameBn,
  ...
  return (
    ...
    >
       ...
       <UMBreadCrumb pageName="Area" lastName="View" link="/super_admin/hk/area" />
            ...
            <Link href={`/super_admin/hk/area`}>
              ...
              >
                <DarazCommonRedirectButton
                  to={`/super_admin/hk/area/edit/${id}`}
                >
                  Go to edit
                </DarazCommonRedirectButton>
