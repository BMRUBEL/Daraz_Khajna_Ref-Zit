...
const CreateDivisionPage = () => {
  ...
  const [addDivision, { data: createData }] = useAddDivisionMutation();
  console.log(createData, "createDivision");
  ...
  const onSubmit = async (values: any) => {
    try {
      ...
      setLoading(true);
      const res = await addDivision(values);
      ...
      if (res) {
        if(res?.data?.code===400){
          ...
          router.push(`/super_admin/hk/division/view/${res?.data?.result?.id}`);
          setLoading(false);
        }else{
  ...
  return (
    ...
    >
       ...
       <UMBreadCrumb pageName="Division" lastName="Create" link={`/super_admin/hk/division`} />
      ...
      >
        <Form submitHandler={onSubmit} resolver={yupResolver(divisionSchema)}>
          <div
            style={{
              padding: "0px",
              marginTop: "12px",
