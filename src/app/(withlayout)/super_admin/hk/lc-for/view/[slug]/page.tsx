...
const ViewLCForPage = ({ params }: any) => {
  // state
  ...
  return (
    ...
    >
      ...
      <UMBreadCrumb pageName="LC For" lastName="View" link={`/super_admin/hk/lc-for`} />
            ...
            <Link href={`/super_admin/hk/lc-for`}>
              ...
              >
                <DarazCommonRedirectButton
                  to={`/super_admin/hk/lc-for/edit/${id}`}
                >
                  Go to edit
                </DarazCommonRedirectButton>
