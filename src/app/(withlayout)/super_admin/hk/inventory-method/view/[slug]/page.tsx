...
const ViewInventoryMethodPage = ({ params }: any) => {
  // state
  ...
  return (
    ...
    >
      ...
      <UMBreadCrumb pageName="Inventory Method" lastName="View" link="/super_admin/hk/inventory-method" />
            ...
            <Link href={`/super_admin/hk/inventory-method`}>
              ...
              >
                <DarazCommonRedirectButton
                  to={`/super_admin/hk/inventory-method/edit/${id}`}
                >
                  Go to edit
                </DarazCommonRedirectButton>
...
export default ViewInventoryMethodPage;
