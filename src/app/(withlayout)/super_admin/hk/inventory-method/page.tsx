...
import { useInventorymethodsQuery } from "@/redux/api/housekeepingApi/inventoryMethodApi";
...
const InventoryMethod = () => {
  ...
  // get department data
  const { data: transactionData, isLoading } = useInventorymethodsQuery({
    ...query,
    page: page,
    size: size,
    sortField: sortBy,
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: "invMethodName",
      width: 250,
      align: "center",
    },

    {
      title: "Inven Method Name BN",
      dataIndex: "invMethodNameBn",
      width: 300,
      align: "center",
    },
    {
    ...
    },
    {
      ...
      render: (record: any) => (
        ...
        >
          <Link href={`/super_admin/hk/inventory-method/view/${record}`}>
            <Button
              style={{
                fontSize: "13px",
          ...
          <Link href={`/super_admin/hk/inventory-method/edit/${record}`}>
            <Button
              className="bg-[#FF5100]"
              style={{
                fontSize: "13px",
  ...
  return (
    <>
      ...
      >
        <UMBreadCrumb pageName="Inventory Method" />

        <div>
          <ActionBar>
          <DarazCommonAddButton
              to={`/super_admin/hk/inventory-method/create`}
            >
              + Add New
            </DarazCommonAddButton>
          <div>
...
export default InventoryMethod;
