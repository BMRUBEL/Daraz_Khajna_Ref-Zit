...
import { useVatStructureDropDownQuery, useAddVatStructureMutation } from "@/redux/api/housekeepingApi/vatStructureApi"
import { Button, Col, Row, Select, message, Radio, Space, DatePicker } from "antd";
...
const CreateVat = () => {
  ...
  //save
  const [addVat, { data: createData }] = useAddVatStructureMutation();
  ...
  //   updatedRows[index].vatRateRefId = value;
  //   updatedRows[index].uomId = value;
  //   updatedRows[index].fixedRateUomId = value;
  //   updatedRows[index].exd = value;
  //   updatedRows[index].atv = value;
  //   updatedRows[index].active = activeStatus;
  //   updatedRows[index].tti = value;
  //   console.log(value, "Vat Rate Ref")
  //   setRows(updatedRows);
  // };
  ...
  const onSubmit = async (values: any) => {
    // Master params
    // values.hsCodeId = values.hsCodeId;
    // values.fiscalYearId = values.fiscalYearId;
    ...
    try {
      ...
      setLoading(true);
      const res = await addVat(values);
      console.log(res, "Response");

      if ('data' in res && res.data && res.data.result) {
        message.success("Vat created successfully!");
  ...
  return (
    ...
    >
        ...
        <UMBreadCrumb pageName="Vat Structure" lastName="Create"  link="/super_admin/hk/vat-structure" />
