...
const CreateCustomerPage = () => {
  ...
  const onSubmit = async (values: any) => {
    ...
    (values.registrationStatus = true),
      (values.registrationStatus = values.registrationStatus ? 1 : 0);
    (values.active = true), (values.active = values.active ? 1 : 0);
    ...
    try {
      ...
      if (res) {
        ...
        router.push(`/super_admin/company-setting/supplier-info/view/${res?.data?.result?.id}`);
        setLoading(false);
      }
      ...
      >
        <div style={{}}>
          ...
          >
              ...
              <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
                ...
                >
                  <FormInput
                    ...
                    name="customerNameBn"
                    size="large"
                    label="Supplier Name Bn:"
                    placeholder="Enter Supplier Name Bn..."
                    required
                  />
                </Col>
                <Col
                    ...
                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                      <thead className="bg-orange-thead   text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                          ...
                          <th className="px-2 py-2">Supplier Account Number</th>
                          <th className="px-2 py-2">
                            Supplier Account Number Bn{" "}
                          </th>
                        </tr>
                      </thead>
                      <tbody>
            ...
            >
              <Link href={`/super_admin/company-setting/supplier-info`}>
                {" "}
