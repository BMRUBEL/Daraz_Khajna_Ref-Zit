...
const ViewCustomerPage = ({ params }: any) => {
  ...
  return (
    ...
    >
      <UMBreadCrumb lastName="Home" pageName="View" />
      <div
        style={{
          padding: "20px 0px",
          marginTop: "0px",
        ...
        <div style={{}}>
          ...
          >
                ...
                >
                  ...
                  <div className="relative overflow-x-auto  sm:rounded-lg">
                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                      ...
                      <tbody>
                        {bankDetailsData.map((item: any, index: number) => (
                          <tr key={index}>
                ...
                >
                  ...
                  <div className="relative overflow-x-auto  sm:rounded-lg">
                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                      ...
                      <tbody>
                        {addressesData.map((item: any, index: number) => (
                          <tr key={index}>
            ...
            >
              ...
              <Link href={`/super_admin/company-setting/supplier-info/edit/${id}`}>
