...
import { Button, Input, Switch, message, Image } from "antd";
...
const CompanyInfo = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (record: any) => (
        ...
        >
          <Link
            href={`/super_admin/company-setting/company-Info/view/${record}`}
          >
            <Button
              style={{
                fontSize: "13px",
          ...
          <Link
            href={`/super_admin/company-setting/company-Info/edit/${record}`}
          >
            <Button
              className="bg-[#FF5100]"
              style={{
  ...
  return (
    <>
      ...
      >
        <UMBreadCrumb pageName="Company Info" />

        <div>
          <ActionBar>
           
            <DarazCommonAddButton
              to={"/super_admin/company-setting/company-Info/create"}
            >
              + Add New
            </DarazCommonAddButton>
            <div>
