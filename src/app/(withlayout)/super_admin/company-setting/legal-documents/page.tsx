...
const ManageAdmin = () => {
  ...
  const columns = [
    ...
    {
      title: "SL",
      dataIndex: "vdsPurchaserMasterId",
      sorter: true,
      width: 250,
      align: "center",
    },
    ...
    },
    {
      ...
      render: (record: any) => (
        ...
        >
          <Link href={`/super_admin/company-setting/legal-documents/view/${record}`}>
            <Button
              style={{
                fontSize: "13px",
          ...
          <Link href={`/super_admin/company-setting/legal-documents/edit/${record}`}>
            <Button
              className="bg-[#FF5100]"
              style={{
                fontSize: "13px",
  ...
  return (
    <>
      ...
      >
        <UMBreadCrumb pageName="Legal Docs" />

        <div>
          <ActionBar>
            <Link
              href="/super_admin/company-setting/legal-documents/create"
