...
import { useItemSubGroupQuery } from "@/redux/api/housekeepingApi/itemSubGroupApi";
...
const ManageAdmin = () => {
  ...
  // get department data
  const { data: transactionData, isLoading } = useItemSubGroupQuery({
    ...query,
  });
  ...
  const columns = [
    ...
    {
      title: "Sub Group Name Bn",
      dataIndex: "trnsTypeName",
      width: 300,
      align: "center",
    },
    {
      title: "Sub Group Prefix",
    ...
    },
    {
      ...
      render: (record: any) => (
        ...
        >
          <Link href={`/super_admin/company-setting/items/item-sub-group/view/${record}`}>
            <Button
              style={{
                fontSize: "13px",
          ...
          <Link href={`/super_admin/company-setting/items/item-sub-group/edit/${record}`}>
            <Button
              className="bg-[#FF5100]"
              style={{
                fontSize: "13px",
  ...
  return (
    <>
      ...
      >
        <UMBreadCrumb pageName="item-sub-group" />

        <div>
          <ActionBar>
            <Link
              href="/super_admin/company-setting/items/item-sub-group/create"
