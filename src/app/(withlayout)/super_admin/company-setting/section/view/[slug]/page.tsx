...
const ViewSection = ({ params }: any) => {
  ...
  return (
    ...
    >
      <UMBreadCrumb pageName="Section" lastName="View" />
      <div
        style={{
          padding: "20px",
          marginTop: "11px",
      ...
      >
        <Form submitHandler={onSubmit} defaultValues={defaultValue}>
          ...
          >
            <Link
              href={`/super_admin/company-setting/section`}
            >
              <div
                style={{
                  display: "flex",
              ...
              >
                <DarazCommonRedirectButton
                  to={`/super_admin/company-setting/section/edit/${id}`}
                >
                  Go to edit
                </DarazCommonRedirectButton>
