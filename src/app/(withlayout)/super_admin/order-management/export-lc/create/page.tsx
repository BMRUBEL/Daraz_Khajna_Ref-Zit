...
} from "@/redux/api/OrderManagementApi/exportLcApi";
    ...
    >
      ...
      >
        <div style={{}}>
          ...
          >
            <p className="text-xl font-semibold pb-4">Insert</p>
            <div
              style={{
                marginBottom: "10px",
                padding: "20px",
              ...
              <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
                ...
                >
                  <DRZSelectField
                    ...
                    label="Export LC ID: "
                    placeholder="Search Export LC ID"
                    required
                    onSearch={onSearch}
                ...
                >
                  <DRZSelectField
                    ...
                    options={suppliersOptions}
                    label="Export LC No: "
                    placeholder="Search Export LC No"
                    required
                    onSearch={onSearch}
                    filterOption={filterOption}
                  />
                ...
                >
                  ...
                  <div className="relative overflow-x-auto sm:rounded-lg">
                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                      <thead className="bg-orange-thead text-xs text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400 text-center">
                        <tr>
                        ...
                        {rows.map((row, index) => (
                          <tr key={index}>
                            ...
                            <td>
                              <input
                                type="number"
                                className="border-none rounded mt-3 w-full p-2 mb-4 text-center"
                                name="itemReceiveRate"
                                value={row.uomId}
                                onChange={(e) => {
                                  const updatedRows = [...rows];
                                  updatedRows[index].itemInfoId = e;
                                  setRows(updatedRows);
                                }}
                                readOnly
                                placeholder="S/L"
