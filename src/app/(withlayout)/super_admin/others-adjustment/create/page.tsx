...
const CreateOthersAdjustment = () => {
  ...
  const onAddRow = () => {
    ...
    const newRow: DataType = {
      key: nextKey++,
      serviceDescription: `New Row ${nextKey}`,
      billAmount: 0,
  ...
  return (
    <div style={{ padding: "10px" }}>
      <UMBreadCrumb pageName="Others Adjustment" lastName="Insert" />
      <div
        style={{
          padding: "20px",
          marginTop: "11px",
          ...
          <div
            ...
            >
              ...
              >
                ...
                >
                  <Link href={`/super_admin/others-adjustment`}>
                    {" "}
                    <DarazCommonCloseButton>Close</DarazCommonCloseButton>
                  </Link>
                  <DarazCommonRedirectButton to="/super_admin/others-adjustment/create">Reset</DarazCommonRedirectButton>
